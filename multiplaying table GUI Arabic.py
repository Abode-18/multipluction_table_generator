...
school_label_top = tk.Label(root, text="ثانوية الموهوبين التقنية بجدة", font=("Arial", 26, "bold"), bg="#FFD700", fg="#8B0000")
school_label_top.pack(pady=10)  # English: school name displayed after logo

# Title label
title_label = tk.Label(root, text="مولد جدول الضرب", font=("Arial", 30, "bold"), bg="#FFD700", fg="#8B0000")
...
label_start = tk.Label(frame_inputs, text=":بداية من جدول الضرب", font=("Arial", 18), bg="#FFD700", fg="#00008B")
...
label_end = tk.Label(frame_inputs, text=":إلى", font=("Arial", 18), bg="#FFD700", fg="#00008B")
...
# Student credit
student_label = tk.Label(root, text="عمل الطالب: عبدالرحمن بدر العويضي", font=("Arial", 18, "italic"), bg="#FFD700", fg="#00008B")
