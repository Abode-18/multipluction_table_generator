...
try:
    ...
    logo_label = tk.Label(root, text="[شعار المدرسة]", font=("Arial", 20), bg=BG_Color, fg="#00008B")
    logo_label.pack(pady=10)
    print("Error loading logo:", e)


# School name after logo
school_label_top = tk.Label(root, text="ثانوية الموهوبين التقنية بجدة", font=("Arial", 26, "bold"), bg=BG_Color, fg="#8B0000")
school_label_top.pack(pady=10)  # English: school name displayed after logo

# Title label
title_label = tk.Label(root, text="مولد جدول الضرب", font=("Arial", 30, "bold"), bg=BG_Color, fg="#8B0000")
...
label_start = tk.Label(frame_inputs, text=":بداية من جدول الضرب", font=("Arial", 18), bg=BG_Color, fg="#00008B")
label_start.grid(row=0, column=1, padx=20, pady=10, sticky="e")
entry_start = tk.Entry(frame_inputs, font=("Arial", 24), width=10)
entry_start.grid(row=0, column=0, padx=20, pady=10)

label_end = tk.Label(frame_inputs, text=":إلى", font=("Arial", 18), bg=BG_Color, fg="#00008B")
label_end.grid(row=1, column=1, padx=20, pady=10, sticky="e")
entry_end = tk.Entry(frame_inputs, font=("Arial", 24), width=10)
entry_end.grid(row=1, column=0, padx=20, pady=10)

# Run button
run_button = tk.Button(root, text="احسب جدول الضرب", font=("Arial", 18, "bold"), bg="#32CD32", fg="white", command=multiplaying_table)
...
# Student credit
student_label = tk.Label(root, text="عمل الطالب: عبدالرحمن بدر العويضي", font=("Arial", 18, "italic"), bg=BG_Color, fg="#00008B")
